...
//      { value: "groceries", label: "groceris", checked: false },
...
export default function ProductList() {
  ...
  useEffect(() => {
    const pagination = { _page: page, per_page: ITEMS_PER_PAGE };
      ...
      >
        ...
        <div className="fixed inset-0 z-40 flex">
          ...
          >
            ...
            {/* Filters */}
            {/*For Mobile Filter is yet to add */}
              ...
              <div
                ...
                className={`relative z-10 inline-flex items-center cursor-pointer ${
                  index + 1 === page
                    ...
                    : "text-gray-400 "
                }  px-4 py-2 text-sm font-semibold text-gray-600 focus:z-20 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600`}
              >
                {index + 1}
              </div>
            ))}
          ...
          <div className="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8">
            {products.data?.map((product) => (
              <Link to="/productdetail">
                <div
                  key={product.id}
                  className="group relative border-solid border-2 border-gray-200 p-2 rounded-xl"
                >
                  ...
                  <div className="mt-4 flex justify-between">
                    ...
                    <div>
                      ...
                      <p className="text-sm font-medium text-gray-400 block line-through">
                        {product.price}
                      </p>
                    </div>
                  </div>
